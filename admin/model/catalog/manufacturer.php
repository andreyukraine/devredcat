...
class ModelCatalogManufacturer extends Model {
  ...
  //++Andriy
  public function getTemplateSeoManufacturer($langId, $store_id, $key){
  ...
  //--Andriy
	...
	public function addManufacturer($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', sort_order = '" . (int)$data['sort_order'] . "', noindex = '" . (int)$data['noindex'] . "', in_slide = '" . (int)$data['in_slide'] . "', in_footer = '" . (int)$data['in_footer'] . "'");
		...
		if (isset($data['manufacturer_seo_url'])) {
          ...
          if (empty($keyword)) {
            ...
            $translit_name = $this->model_design_seo_url->translit($data['manufacturer_description'][$language_id]['name']);
	...
	public function editManufacturer($manufacturer_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', sort_order = '" . (int)$data['sort_order'] . "', noindex = '" . (int)$data['noindex'] . "', in_slide = '" . (int)$data['in_slide'] . "', in_footer = '" . (int)$data['in_footer'] . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
