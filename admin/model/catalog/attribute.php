...
class ModelCatalogAttribute extends Model {
	public function addAttribute($data) {
      ...
      if (empty($value['slug'])){
        ...
        $slug = $value['slug'];
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_description SET attribute_id = '" . (int)$attribute_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', slug = '" . $this->db->escape($slug) . "'");
		}
	...
	public function getAttributeDescriptions($attribute_id) {
		...
		foreach ($query->rows as $result) {
			$attribute_data[$result['language_id']] = array('name' => $result['name'], 'slug' => $result['slug']);
		}
