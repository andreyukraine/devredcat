...
class ModelOcslideshowSlide extends Model {
	public function addocslideshow($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "ocslideshow SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "', height = '" . (int)$data['height'] . "',auto = '" . (int)$data['auto'] . "',delay = '" . (int)$data['delay'] . "',hover = '" . (int)$data['hover'] . "',nextback = '" . (int)$data['nextback'] . "',contrl = '" . (int)$data['contrl'] . "',effect = '" . $data['effect'] . "'");
        ...
        if (!empty($ocslideshow_image['video'])){
          $type_slide = 1;
				...
				foreach ($ocslideshow_image['ocslideshow_image_description'] as $language_id => $ocslideshow_image_description) {				
					$this->db->query("INSERT INTO " . DB_PREFIX . "ocslideshow_image_description SET ocslideshow_image_id = '" . (int)$ocslideshow_image_id . "', language_id = '" . (int)$language_id . "', ocslideshow_id = '" . (int)$ocslideshow_id . "', title = '" .  $this->db->escape($ocslideshow_image_description['title']) . "',title_size = '" .  (int)($ocslideshow_image_description['title_size']) . "',sub_title = '" .  $this->db->escape($ocslideshow_image_description['sub_title']) . "',sub_size = '" .  (int)($ocslideshow_image_description['sub_size']) . "',description = '" .  $this->db->escape($ocslideshow_image_description['description']) . "'");
				}
			}
		}		
	}
	...
	public function copySlideshow($ocslideshow_id) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "ocslideshow SET name = '" . $this->db->escape($slideshow['name']) . "', status = '" . (int)$slideshow['status'] . "', height = '" . (int)$slideshow['height'] . "', auto = '" . (int)$slideshow['auto'] . "',delay = '" . (int)$slideshow['delay'] . "',hover = '" . (int)$slideshow['hover'] . "',nextback = '" . (int)$slideshow['nextback'] . "',contrl = '" . (int)$slideshow['contrl'] . "',effect = '" . $slideshow['effect'] . "'");
        ...
        if (!empty($ocslideshow_image['video'])){
          $type_slide = 1;
				...
				foreach ($ocslideshow_image['ocslideshow_image_description'] as $language_id => $ocslideshow_image_description) {
					$this->db->query("INSERT INTO " . DB_PREFIX . "ocslideshow_image_description SET ocslideshow_image_id = '" . (int)$ocslideshow_image_id . "', language_id = '" . (int)$language_id . "', ocslideshow_id = '" . (int)$ocslideshow_id . "', title = '" .  $this->db->escape($ocslideshow_image_description['title']) . "',title_size = '" .  (int)($ocslideshow_image_description['title_size']) . "', title_color = '" .  $this->db->escape($ocslideshow_image_description['title_color']) . "', sub_title_color = '" .  $this->db->escape($ocslideshow_image_description['sub_title_color']) . "', sub_title = '" .  $this->db->escape($ocslideshow_image_description['sub_title']) . "',sub_size = '" .  (int)($ocslideshow_image_description['sub_size']) . "',description = '" .  $this->db->escape($ocslideshow_image_description['description']) . "'");
				}
			}
		}
	}
	...
	public function editocslideshow($ocslideshow_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "ocslideshow SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "', height = '" . (int)$data['height'] . "',auto = '" . (int)$data['auto'] . "',delay = '" . (int)$data['delay'] . "',hover = '" . (int)$data['hover'] . "',nextback = '" . (int)$data['nextback'] . "',effect = '" . $data['effect'] . "',contrl = '" . (int)$data['contrl'] . "' WHERE ocslideshow_id = '" . (int)$ocslideshow_id . "'");
	...
	public function getocslideshowImages($ocslideshow_id) {
      ...
      foreach ($ocslideshow_image_description_query->rows as $ocslideshow_image_description) {
        $ocslideshow_image_description_data[$ocslideshow_image_description['language_id']] = array(
          'title' => $ocslideshow_image_description['title'],
          'title_size' => $ocslideshow_image_description['title_size'],
          'title_color' => $ocslideshow_image_description['title_color'],
          'sub_title' => $ocslideshow_image_description['sub_title'],
          'sub_size' => $ocslideshow_image_description['sub_size'],
          'sub_title_color' => $ocslideshow_image_description['sub_title_color'],
