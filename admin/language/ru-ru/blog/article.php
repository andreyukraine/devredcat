...
$_['help_related_product']   = '(Автодоповнення)';
$_['help_tag']          	 = 'Теги поділяються комою';
$_['help_noindex']           = 'Індексація пошуковими системами Google,  Bing та ін.';
