...
<div id="content" style="background-color:#f4f4f3 !important;">
    <div class="row">
        <div class="col-xs-4"></div>
            ...
            <div class="col-xs-4 text-right">v<?php echo $version; ?></div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-10" style="padding: 50px; background-color:white; border: 1px solid #ccc; border-radius:24px;">
                <form action="<?php echo $action ;?>" method="post" enctype="multipart/form-data" id="form">
                    <div class="row">
                        <div class="col-xs-12">
                            <label class="col-sm-4" for="input-status" style="position:absolute; margin-left: 6px; font-size: 14px; margin-top: 1px; font-weight:300;">
                                <span data-toggle="tooltip" title="<?php echo $tooltip_entry_status ;?>"><?php echo $entry_status ;?></span>
                            </label>
                        ...
                        <div class="col-xs-12">
                            <label class="col-sm-4" for="input-merchant" style="position:absolute; margin-left: 6px; font-size: 14px; margin-top: 1px; font-weight:300;">
                                <span data-toggle="tooltip" title="<?php echo $tooltip_entry_merchant ;?>"><?php echo $entry_merchant ;?></span>
                            </label>
                            <input style="margin-bottom:0%;" type="text" name="mono_merchant" value="<?php echo $mono_merchant ;?>" id="input-merchant" class="mono-select" required/>
                                ...
                                <?php } ?>
                            <p class="mono-text"><?php echo $mono_text ;?> <a href="https://https://web.monobank.ua/" style="color:#EA5357;" target="_blank">web.monobank.ua</a></p>
                        </div>
                        <div class="col-xs-12">
                            <label class="col-sm-4 control-label" for="input-geo-zone" style="position:absolute; margin-left: 6px; font-size: 14px; margin-top: 1px; font-weight:300;"><?php echo $entry_geo_zone ;?>
                            </label>
                        ...
                        <div class="col-xs-12">
                            <label class="col-sm-4 control-label" for="input-sort-order" style="position:absolute; margin-left: 6px; font-size: 14px; margin-top: 1px; font-weight:300;"><?php echo $entry_sort_order ;?>
                            </label>
                            <input type="text" name="mono_sort_order" value="<?php echo $mono_sort_order ;?>" placeholder="<?php echo $entry_sort_order ;?>" id="input-sort-order" class="mono-select" />
                        </div>
                        <div class="col-xs-12">
                            <label class="col-sm-4 control-label" for="input-order-status"  style="position:absolute; margin-left: 6px; font-size: 14px; margin-top: 1px; font-weight:300;"><?php echo $entry_order_success_status ;?></label>
                        ...
                        <div class="col-xs-12">
                            <label class="col-sm-4 control-label" for="input-order-status" style="position:absolute; margin-left: 6px; font-size: 14px; margin-top: 1px; font-weight:300;"><?php echo $entry_order_cancelled_status ;?></label>
                        ...
                        <div class="col-xs-12">
                            <label class="col-sm-4 control-label" for="input-order-status" style="position:absolute; margin-left: 6px; font-size: 14px; margin-top: 1px; font-weight:300;"><?php echo $entry_order_process_status ;?></label>
                    ...
                    <div class="row">
                        <div class="col-xs-10">
                            <button type="submit" form="form" data-toggle="tooltip" class="save-btn"><?php echo $save_btn ;?></button>
                        </div>
                        <div class="col-xs-2">
