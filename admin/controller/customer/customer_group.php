...
class ControllerCustomerCustomerGroup extends Controller {
	...
	protected function getForm() {
		...
		$data['customer_prices'] = $this->model_customer_customer_price->getCustomerPrices();
		...
		if (isset($this->request->post['customer_price_id'])) {
			$data['customer_price_id'] = $this->request->post['customer_price_id'];
		} elseif (!empty($customer_group_info)) {
			$data['customer_price_id'] = $customer_group_info['customer_price_id'];
		} else {
			$data['customer_price_id'] = 0;
		}
