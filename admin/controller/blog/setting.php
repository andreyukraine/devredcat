...
class ControllerBlogSetting extends Controller {
    ...
    $data['languages'] = $this->model_localisation_language->getLanguages();
		...
		if (isset($this->request->post['configblog_html_h1'])) {
			...
			$data['configblog_html_h1'] = $this->model_setting_setting->getValuesLangByKey(0, "configblog_html_h1", "configblog");
		}
		
		if (isset($this->request->post['configblog_meta_title'])) {
			$data['configblog_meta_title'] = $this->request->post['configblog_meta_title'];
		} else {
			$data['configblog_meta_title'] = $this->model_setting_setting->getValuesLangByKey(0, "configblog_meta_title", "configblog");
		}
		...
		if (isset($this->request->post['configblog_meta_description'])) {
			...
			$data['configblog_meta_description'] = $this->model_setting_setting->getValuesLangByKey(0, "configblog_meta_description", "configblog");
		}

		if (isset($this->request->post['configblog_meta_keyword'])) {
			$data['configblog_meta_keyword'] = $this->request->post['configblog_meta_keyword'];
		} else {
      $data['configblog_meta_keyword'] = $this->model_setting_setting->getValuesLangByKey(0, "configblog_meta_keyword", "configblog");
		}
