...
class ControllerUserUserPermission extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['permission']['zone'])) {
			$data['user_group_zones'] = $this->request->post['permission']['zone'];
		} elseif (isset($user_group_info['permission']['zone'])) {
			$data['user_group_zones'] = $user_group_info['permission']['zone'];
		} else {
			$data['user_group_zones'] = array();
		}
		...
		if (isset($this->request->post['permission']['customer_group'])) {
			$data['user_group_customer_groups'] = $this->request->post['permission']['customer_group'];
		} elseif (isset($user_group_info['permission']['customer_group'])) {
			$data['user_group_customer_groups'] = $user_group_info['permission']['customer_group'];
		} else {
			$data['user_group_customer_groups'] = array();
		}
