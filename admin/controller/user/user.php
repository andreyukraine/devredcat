...
class ControllerUserUser extends Controller {
	...
	protected function getList() {
      ...
      $user_group = $this->model_user_user_group->getUserGroup($result['user_group_id']);
        ...
        'email'       => $result['email'],
        'usern_group' => isset($user_group['name']) ? $user_group['name'] : "",
    ...
    if (isset($this->request->post['code_erp'])) {
      $data['code_erp'] = $this->request->post['code_erp'];
    } elseif (!empty($user_info)) {
      $data['code_erp'] = $user_info['code_erp'];
    } else {
      $data['code_erp'] = '';
    }
