...
class ControllerCommonHeader extends Controller {
	public function index() {
      ...
      $data['refresh'] = $this->url->link('marketplace/modification/refresh_ajax', 'user_token=' . $this->session->data['user_token'], true);
      $data['refresh_ajax_url'] = str_replace('&amp;', '&', $data['refresh']);
