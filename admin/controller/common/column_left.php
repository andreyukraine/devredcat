...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
      ...
      if ($this->user->hasPermission('access', 'catalog/occategorythumbnail')) {
        $catalog[] = array(
          'name'	   => "Категорії популярні",
          'href'     => $this->url->link('catalog/occategorythumbnail', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }

      if ($this->user->hasPermission('access', 'extension/module/occategory_popular')) {
        $catalog[] = array(
          'name'	   => "Категорії для улюбленця",
          'href'     => $this->url->link('extension/module/occategory_popular/list', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }
...
//			}
			...
			if ($this->user->hasPermission('access', 'catalog/filter_settings')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_filter_settings'),
      ...
      if ($this->user->hasPermission('access', 'extension/module/ocredirect')) {
        $design[] = array(
          'name'	   => "OC Redirect",
          'href'     => $this->url->link('extension/module/ocredirect', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }
			...
			if ($this->user->hasPermission('access', 'customer/customer_price')) {
				$customer[] = array(
					'name'	   => $this->language->get('text_customer_price'),
					'href'     => $this->url->link('customer/customer_price', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
      ...
      //++Andrey
      if ($this->user->hasPermission('access', 'extension/module/occallback')) {
        $customer[] = array(
          'name'	   => 'Зворотній дзвінок',
          'href'     => $this->url->link('extension/module/occallback/index', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }
      //--Andrey
      ...
      //++Andrey
      if ($this->user->hasPermission('access', 'extension/module/popups')) {
        $marketing[] = array(
          'name'	   => 'Вспливаючі вікна',
          'href'     => $this->url->link('extension/module/popups/index', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }
      ...
      if($this->user->hasPermission('access', 'extension/module/ocakcii')) {
        $marketing[] = array(
          'name'     => "Акції",
      ...
      if($this->user->hasPermission('access', 'extension/module/ocimagecrop')) {
        $marketing[] = array(
          'name'     => "Image crop",
      ...
      if ($this->user->hasPermission('access', 'customer/push_notification')) {
        $user[] = array(
      ...
      //++Andrey
      if ($this->user->hasPermission('access', 'extension/module/ocpolicy')) {
        $system[] = array(
          'name'	   => 'Policy cookie',
          'href'     => $this->url->link('extension/module/ocpolicy/index', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }
      //--Andrey
      ...
      if ($this->user->hasPermission('access', 'catalog/product_status')) {
        $localisation[] = array(
          'name'	   => $this->language->get('text_product_status'),
          'href'     => $this->url->link('catalog/product_status', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }
			...
			if ($this->user->hasPermission('access', 'localisation/street')) {
				$localisation[] = array(
					'name'	   => $this->language->get('text_street'),
					'href'     => $this->url->link('localisation/street', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'localisation/post')) {
				$localisation[] = array(
					'name'	   => $this->language->get('text_post'),
					'href'     => $this->url->link('localisation/post', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
      ...
      if ($this->user->getGroupId() == 1) {
        $data['menus'][] = array(
          ...
          'icon' => 'fa-cog',
          'name' => "Cards client",
          'href' => $this->url->link('extension/module/occards/list', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
        $data['menus'][] = array(
          'id' => 'menu-system',
        ...
        $data['menus'][] = array(
          ...
          'icon' => 'fa-cog',
          'name' => "Import",
          'href' => $this->url->link('extension/module/ocimport/import', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }
      //--Andrey
