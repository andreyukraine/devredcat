...
class ControllerSettingSetting extends Controller {
    ...
    //setting gpt
    if (isset($this->request->post['config_model_gpt'])) {
      $data['config_model_gpt'] = $this->request->post['config_model_gpt'];
    } else {
      $data['config_model_gpt'] = $this->config->get('config_model_gpt');
    }
    if (isset($this->request->post['config_key_gpt'])) {
      $data['config_key_gpt'] = $this->request->post['config_key_gpt'];
    } else {
      $data['config_key_gpt'] = $this->config->get('config_key_gpt');
    }

    //main home
    if (isset($this->request->post['config_h1_title'])) {
      $data['config_h1_title'] = $this->request->post['config_h1_title'];
    } else {
      $data['config_h1_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_h1_title");
    }
    if (isset($this->request->post['config_meta_title'])) {
      $data['config_meta_title'] = $this->request->post['config_meta_title'];
    } else {
      $data['config_meta_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_meta_title");
    }
    if (isset($this->request->post['config_meta_description'])) {
      $data['config_meta_description'] = $this->request->post['config_meta_description'];
    } else {
      $data['config_meta_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_meta_description");
    }
    if (isset($this->request->post['config_meta_keyword'])) {
      $data['config_meta_keyword'] = $this->request->post['config_meta_keyword'];
    } else {
      $data['config_meta_keyword'] = $this->model_setting_setting->getValuesLangByKey(0, "config_meta_keyword");
    }
    if (isset($this->request->post['config_home_description'])) {
      $data['config_home_description'] = $this->request->post['config_home_description'];
    } else {
      $data['config_home_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_home_description");
    }

    //meta category
    if (isset($this->request->post['config_gen_seo_cat_h1'])) {
      $data['config_gen_seo_cat_h1'] = $this->request->post['config_gen_seo_cat_h1'];
    } else {
      $data['config_gen_seo_cat_h1'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_cat_h1");
    }
    if (isset($this->request->post['config_gen_seo_cat_gpt_h1'])) {
      $data['config_gen_seo_cat_gpt_h1'] = $this->request->post['config_gen_seo_cat_gpt_h1'];
    } else {
      $data['config_gen_seo_cat_gpt_h1'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_cat_gpt_h1");
    }
    if (isset($this->request->post['config_gen_seo_cat_title'])) {
      $data['config_gen_seo_cat_title'] = $this->request->post['config_gen_seo_cat_title'];
    } else {
      $data['config_gen_seo_cat_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_cat_title");
    }
    if (isset($this->request->post['config_gen_seo_cat_gpt_title'])) {
      $data['config_gen_seo_cat_gpt_title'] = $this->request->post['config_gen_seo_cat_gpt_title'];
    } else {
      $data['config_gen_seo_cat_gpt_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_cat_gpt_title");
    }
    if (isset($this->request->post['config_gen_seo_cat_meta_description'])) {
      $data['config_gen_seo_cat_meta_description'] = $this->request->post['config_gen_seo_cat_meta_description'];
    } else {
      $data['config_gen_seo_cat_meta_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_cat_meta_description");
    }
    if (isset($this->request->post['config_gen_seo_cat_gpt_meta_description'])) {
      $data['config_gen_seo_cat_gpt_meta_description'] = $this->request->post['config_gen_seo_cat_gpt_meta_description'];
    } else {
      $data['config_gen_seo_cat_gpt_meta_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_cat_gpt_meta_description");
    }
    if (isset($this->request->post['config_gen_seo_cat_gpt_description'])) {
      $data['config_gen_seo_cat_gpt_description'] = $this->request->post['config_gen_seo_cat_gpt_description'];
    } else {
      $data['config_gen_seo_cat_gpt_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_cat_gpt_description");
    }
    if (isset($this->request->post['config_gen_seo_cat_gpt_description_top'])) {
      $data['config_gen_seo_cat_gpt_description_top'] = $this->request->post['config_gen_seo_cat_gpt_description_top'];
    } else {
      $data['config_gen_seo_cat_gpt_description_top'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_cat_gpt_description_top");
    }
    if (isset($this->request->post['config_gen_seo_cat_gpt_description_bottom'])) {
      $data['config_gen_seo_cat_gpt_description_bottom'] = $this->request->post['config_gen_seo_cat_gpt_description_bottom'];
    } else {
      $data['config_gen_seo_cat_gpt_description_bottom'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_cat_gpt_description_bottom");
    }

    //meta products
    if (isset($this->request->post['config_gen_seo_prod_h1'])) {
      $data['config_gen_seo_prod_h1'] = $this->request->post['config_gen_seo_prod_h1'];
    } else {
      $data['config_gen_seo_prod_h1'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_prod_h1");
    }
    if (isset($this->request->post['config_gen_seo_prod_gpt_h1'])) {
      $data['config_gen_seo_prod_gpt_h1'] = $this->request->post['config_gen_seo_prod_gpt_h1'];
    } else {
      $data['config_gen_seo_prod_gpt_h1'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_prod_gpt_h1");
    }
    if (isset($this->request->post['config_gen_seo_prod_title'])) {
      $data['config_gen_seo_prod_title'] = $this->request->post['config_gen_seo_prod_title'];
    } else {
      $data['config_gen_seo_prod_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_prod_title");
    }
    if (isset($this->request->post['config_gen_seo_prod_gpt_title'])) {
      $data['config_gen_seo_prod_gpt_title'] = $this->request->post['config_gen_seo_prod_gpt_title'];
    } else {
      $data['config_gen_seo_prod_gpt_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_prod_gpt_title");
    }
    if (isset($this->request->post['config_gen_seo_prod_meta_description'])) {
      $data['config_gen_seo_prod_meta_description'] = $this->request->post['config_gen_seo_prod_meta_description'];
    } else {
      $data['config_gen_seo_prod_meta_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_prod_meta_description");
    }
    if (isset($this->request->post['config_gen_seo_prod_gpt_meta_description'])) {
      $data['config_gen_seo_prod_gpt_meta_description'] = $this->request->post['config_gen_seo_prod_gpt_meta_description'];
    } else {
      $data['config_gen_seo_prod_gpt_meta_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_prod_gpt_meta_description");
    }
    if (isset($this->request->post['config_gen_seo_prod_gpt_description'])) {
      $data['config_gen_seo_prod_gpt_description'] = $this->request->post['config_gen_seo_prod_gpt_description'];
    } else {
      $data['config_gen_seo_prod_gpt_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_prod_gpt_description");
    }

    //meta brands
    if (isset($this->request->post['config_gen_seo_brand_h1'])) {
      $data['config_gen_seo_brand_h1'] = $this->request->post['config_gen_seo_brand_h1'];
    } else {
      $data['config_gen_seo_brand_h1'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_brand_h1");
    }
    if (isset($this->request->post['config_gen_seo_brand_gpt_h1'])) {
      $data['config_gen_seo_brand_gpt_h1'] = $this->request->post['config_gen_seo_brand_gpt_h1'];
    } else {
      $data['config_gen_seo_brand_gpt_h1'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_brand_gpt_h1");
    }
    if (isset($this->request->post['config_gen_seo_brand_title'])) {
      $data['config_gen_seo_brand_title'] = $this->request->post['config_gen_seo_brand_title'];
    } else {
      $data['config_gen_seo_brand_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_brand_title");
    }
    if (isset($this->request->post['config_gen_seo_brand_gpt_title'])) {
      $data['config_gen_seo_brand_gpt_title'] = $this->request->post['config_gen_seo_brand_gpt_title'];
    } else {
      $data['config_gen_seo_brand_gpt_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_brand_gpt_title");
    }
    if (isset($this->request->post['config_gen_seo_brand_meta_description'])) {
      $data['config_gen_seo_brand_meta_description'] = $this->request->post['config_gen_seo_brand_meta_description'];
    } else {
      $data['config_gen_seo_brand_meta_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_brand_meta_description");
    }
    if (isset($this->request->post['config_gen_seo_brand_gpt_meta_description'])) {
      $data['config_gen_seo_brand_gpt_meta_description'] = $this->request->post['config_gen_seo_brand_gpt_meta_description'];
    } else {
      $data['config_gen_seo_brand_gpt_meta_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_brand_gpt_meta_description");
    }
    if (isset($this->request->post['config_gen_seo_brand_gpt_description'])) {
      $data['config_gen_seo_brand_gpt_description'] = $this->request->post['config_gen_seo_brand_gpt_description'];
    } else {
      $data['config_gen_seo_brand_gpt_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_brand_gpt_description");
    }
    if (isset($this->request->post['config_gen_seo_brand_gpt_description_top'])) {
      $data['config_gen_seo_brand_gpt_description_top'] = $this->request->post['config_gen_seo_brand_gpt_description_top'];
    } else {
      $data['config_gen_seo_brand_gpt_description_top'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_brand_gpt_description_top");
    }
    if (isset($this->request->post['config_gen_seo_brand_gpt_description_bottom'])) {
      $data['config_gen_seo_brand_gpt_description_bottom'] = $this->request->post['config_gen_seo_brand_gpt_description_bottom'];
    } else {
      $data['config_gen_seo_brand_gpt_description_bottom'] = $this->model_setting_setting->getValuesLangByKey(0, "config_gen_seo_brand_gpt_description_bottom");
    }

    if (isset($this->request->post['config_soc_telegram'])) {
      $data['config_soc_telegram'] = $this->request->post['config_soc_telegram'];
    } else {
      $data['config_soc_telegram'] = $this->config->get('config_soc_telegram');
    }
    if (isset($this->request->post['config_soc_facebook'])) {
      $data['config_soc_facebook'] = $this->request->post['config_soc_facebook'];
    } else {
      $data['config_soc_facebook'] = $this->config->get('config_soc_facebook');
    }
    if (isset($this->request->post['config_soc_instagram'])) {
      $data['config_soc_instagram'] = $this->request->post['config_soc_instagram'];
    } else {
      $data['config_soc_instagram'] = $this->config->get('config_soc_instagram');
    }
    if (isset($this->request->post['config_soc_youtube'])) {
      $data['config_soc_youtube'] = $this->request->post['config_soc_youtube'];
    } else {
      $data['config_soc_youtube'] = $this->config->get('config_soc_youtube');
    }

    if (isset($this->request->post['config_lat'])) {
      $data['config_lat'] = $this->request->post['config_lat'];
    } else {
      $data['config_lat'] = $this->config->get('config_lat');
    }

    if (isset($this->request->post['config_lon'])) {
      $data['config_lon'] = $this->request->post['config_lon'];
    } else {
      $data['config_lon'] = $this->config->get('config_lon');
    }

    //seo contact
    if (isset($this->request->post['config_contact_h1_title'])) {
      $data['config_contact_h1_title'] = $this->request->post['config_contact_h1_title'];
    } else {
      $data['config_contact_h1_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_contact_h1_title");
    }
    if (isset($this->request->post['config_contact_meta_title'])) {
      $data['config_contact_meta_title'] = $this->request->post['config_contact_meta_title'];
    } else {
      $data['config_contact_meta_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_contact_meta_title");
    }
    if (isset($this->request->post['config_contact_meta_description'])) {
      $data['config_contact_meta_description'] = $this->request->post['config_contact_meta_description'];
    } else {
      $data['config_contact_meta_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_contact_meta_description");
    }

    //seo discont
    if (isset($this->request->post['config_discont_h1_title'])) {
      $data['config_discont_h1_title'] = $this->request->post['config_discont_h1_title'];
    } else {
      $data['config_discont_h1_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_discont_h1_title");
    }
    if (isset($this->request->post['config_discont_meta_title'])) {
      $data['config_discont_meta_title'] = $this->request->post['config_discont_meta_title'];
    } else {
      $data['config_discont_meta_title'] = $this->model_setting_setting->getValuesLangByKey(0, "config_discont_meta_title");
    }
    if (isset($this->request->post['config_discont_meta_description'])) {
      $data['config_discont_meta_description'] = $this->request->post['config_discont_meta_description'];
    } else {
      $data['config_discont_meta_description'] = $this->model_setting_setting->getValuesLangByKey(0, "config_discont_meta_description");
    }
    ...
    if (isset($this->request->post['config_theme_webp'])) {
      $data['config_theme_webp'] = $this->request->post['config_theme_webp'];
    } else {
      $data['config_theme_webp'] = $this->config->get('config_theme_webp');
    }
    ...
    if (isset($this->request->post['config_menu_product_count'])) {
			$data['config_menu_product_count'] = $this->request->post['config_menu_product_count'];
		} else {
			$data['config_menu_product_count'] = $this->config->get('config_menu_product_count');
		}
    ...
    if (isset($this->request->post['config_warehouse_id'])) {
      $data['config_warehouse_id'] = $this->request->post['config_warehouse_id'];
    } else {
      $data['config_warehouse_id'] = $this->config->get('config_warehouse_id');
    }
    ...
    $data['warehouses'] = $this->model_extension_module_ocwarehouses->getWarehouseList();
    ...
    if (isset($this->request->post['config_is_catalog'])) {
      $data['config_is_catalog'] = $this->request->post['config_is_catalog'];
    } else {
