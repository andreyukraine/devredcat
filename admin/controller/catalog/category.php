...
class ControllerCatalogCategory extends Controller {
    ...
    if (isset($category_info)) {
      foreach ($data['category_store'] as $store_id => $store) {
        foreach ($data['languages'] as $lang) {
          ...
          $temlate_cat_title = $this->model_catalog_category->getTemplateSeoCategoty($lang['language_id'], $store_id, "config_gen_seo_cat_gpt_h1");
          if (!empty($temlate_cat_title['value'])) {
            $data['gpt_tmpl'][$lang['language_id']]["input-meta-h1"] = str_replace(array_keys($oct_replace), array_values($oct_replace), addslashes(str_replace("'", "", $temlate_cat_title['value'])));
          }
          //meta title
          $data['gpt_tmpl'][$lang['language_id']]["input-meta-title"] = "";
          $temlate_cat_title = $this->model_catalog_category->getTemplateSeoCategoty($lang['language_id'], $store_id, "config_gen_seo_cat_gpt_title");
          if (!empty($temlate_cat_title['value'])) {
            $data['gpt_tmpl'][$lang['language_id']]["input-meta-title"] = str_replace(array_keys($oct_replace), array_values($oct_replace), addslashes(str_replace("'", "", $temlate_cat_title['value'])));
          }
          //meta meta_description
          $data['gpt_tmpl'][$lang['language_id']]["input-meta-description"] = "";
          $temlate_cat_meta_description = $this->model_catalog_category->getTemplateSeoCategoty($lang['language_id'], $store_id, "config_gen_seo_cat_gpt_meta_description");
          if (!empty($temlate_cat_meta_description['value'])) {
            $data['gpt_tmpl'][$lang['language_id']]["input-meta-description"] = str_replace(array_keys($oct_replace), array_values($oct_replace), addslashes(str_replace("'", "", $temlate_cat_meta_description['value'])));
          }
          //meta description
          $data['gpt_tmpl'][$lang['language_id']]["input-description"] = "";
          $temlate_cat_description = $this->model_catalog_category->getTemplateSeoCategoty($lang['language_id'], $store_id, "config_gen_seo_cat_gpt_description");
          if (!empty($temlate_cat_description['value'])) {
            $data['gpt_tmpl'][$lang['language_id']]["input-description"] = str_replace(array_keys($oct_replace), array_values($oct_replace), addslashes(str_replace("'", "", $temlate_cat_description['value'])));
          }
        }
      }
    }
