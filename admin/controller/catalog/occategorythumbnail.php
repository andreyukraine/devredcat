...
class ControllerCatalogOccategorythumbnail extends Controller
{
    ...
    protected function getList() {
        ...
        foreach ($results as $result) {
            ...
            $data['categories'][] = array(
                ...
                'name'                  => $result['name'],
                'featured_color'        => $result['featured_color'],
    ...
    protected function getForm() {
        ...
        if (isset($this->request->post['featured_color'])) {
          $data['featured_color'] = $this->request->post['featured_color'];
        } elseif (!empty($category_info)) {
          $data['featured_color'] = $category_info['featured_color'];
        } else {
          $data['featured_color'] = '';
        }
