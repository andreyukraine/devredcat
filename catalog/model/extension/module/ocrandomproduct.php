...
class ModelExtensionModuleOcRandomProduct extends Model
{
  ...
  public function getMostViewedProductsCategory($category_id, $limit)
  {
    $product_data = array();
  ...
  public function getBestSellerProductsCategory($category_id, $limit)
  {
  ...
  public function getProductSpecialsCategory($category_id, $data = array())
  {
  ...
  public function getProductsDealCategory($category_id, $data = array())
  {
    $sql = "SELECT DISTINCT ps.product_id, (
		SELECT AVG(rating) FROM " . DB_PREFIX . "review r1 
		WHERE r1.product_id = ps.product_id AND r1.status = '1' 
