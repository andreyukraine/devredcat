...
$_['text_menu_catalog']  = 'Каталог товарів';
...
$_['text_write_my']      = 'Напишіть нам';
$_['text_contacts']      = 'Контакти';
$_['text_category']      = 'Категорії';
$_['text_information']      = 'Інформація';

$_['type_text_brand']      = 'Каталог по брендам';
$_['type_text_type']      = 'Каталог за тваринами';

$_['type_check_brand']      = 'по брендам';
$_['type_check_type']      = 'за тваринами';
