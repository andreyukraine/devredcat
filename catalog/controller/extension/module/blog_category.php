...
class ControllerExtensionModuleBlogCategory extends Controller {
	public function index() {
		...
		foreach ($categories as $category) {
          ...
          $article_child_count = $this->model_blog_article->getTotalArticles($filter_data);

					$children_data[] = array(
						'blog_category_id' => $child['blog_category_id'],
						'name' => $child['name'],
            'count' => $article_child_count,
      ...
      $article_count = $this->model_blog_article->getTotalArticles($filter_data);
