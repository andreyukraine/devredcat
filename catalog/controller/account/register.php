...
class ControllerAccountRegister extends Controller {
    ...
    if (isset($this->request->post['customer_type'])) {
      $data['customer_group_id'] = $this->request->post['customer_type'];
    }else {
    ...
    $data['back'] = $this->url->link('account/typeclient', '', true);
    ...
    $data['text_type_account'] = $this->language->get('text_type_account');
	...
	private function validate() {
		...
		// Customer Group
		if (isset($this->request->post['customer_type'])) {
			$customer_group_id = $this->request->post['customer_type'];
