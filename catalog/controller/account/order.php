...
class ControllerAccountOrder extends Controller {
	public function index() {
      ...
      if (!empty($result['invoice_prefix'])) {
        $invoice_no = $result['invoice_prefix'] . $result['order_id'];
      }

      $payment_method = $result['payment_code'];
      $shipping_method = $result['shipping_code'];
    ...
    unset($this->session->data['order_id']);
      ...
      $data['text_shipping_house'] = $this->language->get('text_shipping_house');
      $data['text_shipping_apartment'] = $this->language->get('text_shipping_apartment');
			...
			if (!empty($order_info['invoice_prefix'])) {
				$data['invoice_no'] = $order_info['invoice_prefix'] . $order_info['order_id'];
			} else {
				$data['invoice_no'] = $order_info['order_id'];
			}
      ...
      $data['action_pay'] = $this->load->controller('extension/payment/' . $order_info['payment_code']);
      ...
      $data['sum_total_text'] = $this->currency->format($data['sum_total'], $order_info['currency_code'], $order_info['currency_value']);
