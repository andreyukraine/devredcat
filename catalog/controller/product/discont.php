...
class ControllerProductDiscont extends Controller
{
  public function index()
  {
    ...
    $meta_h1_setting = $this->model_setting_setting->getValuesLangByKey($this->config->get('config_store_id'), 'config_discont_h1_title');
    if (!empty($meta_h1_setting[$langId]['value'])){
      $data['heading_title'] = $meta_h1_setting[$langId]['value'];
    }

    $meta_title = $this->language->get('heading_title');
    $meta_title_setting = $this->model_setting_setting->getValuesLangByKey($this->config->get('config_store_id'), 'config_discont_meta_title');
    if (!empty($meta_title_setting[$langId]['value'])) {
      $meta_title = $meta_title_setting[$langId]['value'];
    }
    $this->document->setTitle($meta_title);

    $meta_desc_setting = $this->model_setting_setting->getValuesLangByKey($this->config->get('config_store_id'), 'config_discont_meta_description');
    if (!empty($meta_desc_setting[$langId]['value'])) {
      $this->document->setDescription($meta_desc_setting[$langId]['value']);
    }
